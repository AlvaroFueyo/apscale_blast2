...
def build_parser():
    ...
    g_flags.add_argument(
        ...
        help=(
            ...
            "'apscale2' is the strict MRCA-based scheme (default) and removes the old dominance criterion because apscale_blast2 is intended to work with curated local databases, often already taxonomically deduplicated. 'apscale' replicates the original apscale_blast behaviour (legacy CLI mode)."
        ),
    )
